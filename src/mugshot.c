...
static const u32 sMugshotImg_Tap[] = INCBIN_U32("graphics/mugshots/tap.4bpp.lz");
static const u16 sMugshotPal_Tap[] = INCBIN_U16("graphics/mugshots/tap.gbapal");

static const struct Mugshot sMugshots[] = {
    //ADD YOUR MUGSHOTS HERE
    [MUGSHOT_TAP] = {.x = 22, .y = 8, .width = 48, .height = 48, .image = sMugshotImg_Tap, .palette = sMugshotPal_Tap},
};
