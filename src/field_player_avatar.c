...
static const u8 sPlayerAvatarGfxIds[][2] =
{
    ...
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_REBBIE_NORMAL,     OBJ_EVENT_GFX_REBBIE_NARUTO},
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_REBBIE_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
    ...
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_REBBIE_NARUTO,         PLAYER_AVATAR_FLAG_ON_FOOT},
