...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_LITTLE_BOY_3,     OBJ_EVENT_GFX_LITTLE_GIRL},
...
} sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_LITTLE_BOY_3,     PLAYER_AVATAR_FLAG_ON_FOOT},
    ...
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_LITTLE_GIRL,         PLAYER_AVATAR_FLAG_ON_FOOT},
